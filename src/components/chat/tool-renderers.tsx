  ...
  return (
    <div className="bg-surface-container-low mt-2 flex items-center gap-3 rounded-lg p-3">
      ...
      <button
        ...
        className="border-primary text-primary hover:bg-accent-subtle shrink-0 rounded-full border px-3 py-1.5 text-xs font-medium transition-[color,background-color,transform] duration-150 active:scale-95"
      >
        Show on map
      </button>
    </div>
