  ...
  return (
    <div className="relative h-full min-h-0 w-full">
      ...
      <aside
        ...
        className={`map-tab-layer glass-neu text-on-surface-variant absolute inset-y-0 right-0 flex w-[3.25rem] cursor-default flex-col items-center rounded-2xl py-2.5 ${
