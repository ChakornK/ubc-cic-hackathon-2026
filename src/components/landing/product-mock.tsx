  ...
  return (
    ...
    >
      <div className="bg-surface overflow-hidden rounded-[1.25rem] shadow-sm">
        <div className="bg-surface border-border-subtle/50 flex h-12 items-center justify-between border-b px-3 sm:px-4">
          ...
          <span className="bg-surface text-primary flex size-7 items-center justify-center rounded-lg text-xs font-medium">
            A
          </span>
        </div>
        ...
        <div className="flex min-h-[320px] sm:min-h-[390px]">
          <div className="chat-message-well flex min-w-0 flex-1 flex-col gap-4 p-4 sm:p-6">
            ...
            <div className="max-w-[94%]">
              ...
              <div className="bg-surface text-on-surface rounded-[16px_16px_16px_5px] px-4 py-3 text-sm leading-relaxed">
                ...
                <div className="bg-surface-container-low text-on-surface-variant mt-3 inline-flex max-w-full items-center gap-1.5 rounded-lg px-2.5 py-1.5 font-mono text-xs">
          ...
          <div className="neu-inset border-border-subtle bg-surface-container-low relative hidden w-[40%] shrink-0 overflow-hidden border-l sm:block">
            ...
            <div className="bg-surface/92 absolute top-3 right-3 flex items-center gap-2.5 rounded-xl px-3 py-2 shadow-sm backdrop-blur-sm">
