...
export function ProductMock() {
  return (
    <div
      aria-hidden="true"
      className="glass-neu-strong mx-auto w-full max-w-[940px] overflow-hidden rounded-[1.75rem] p-2 sm:p-3"
    >
      <div className="bg-surface overflow-hidden rounded-[1.25rem] shadow-sm">
        {/* Header — no border, matches current app shell */}
        <div className="bg-surface flex h-12 items-center justify-between px-3 sm:px-4">
          <span className="text-on-surface flex items-center gap-2 text-sm font-medium tracking-[-0.02em]">
            <span className="bg-surface-container-low text-primary flex size-7 items-center justify-center rounded-lg text-[0.6875rem] font-medium">
              R
            </span>
            Reogent
          </span>
          <span className="bg-primary-container text-on-primary-container flex size-7 items-center justify-center rounded-lg text-[0.625rem] font-medium">
            A
          </span>
        </div>

        {/* Content: chat + map at 50/50 */}
        <div className="flex min-h-[320px] sm:min-h-[390px]">
          ...
          <div className="chat-message-well flex min-w-0 flex-1 flex-col gap-4 p-4 sm:p-6">
            {/* User message */}
            <div className="bg-accent-subtle text-on-surface ml-auto max-w-[88%] rounded-[16px_16px_5px_16px] px-4 py-3 text-left text-sm">
            ...
            <div className="max-w-[94%]">
              ...
              <div className="bg-surface text-on-surface rounded-[16px_16px_16px_5px] px-4 py-3 text-sm leading-relaxed">
                ICCS to the AMS Nest is about 650 meters, roughly an 8 minute walk heading north through campus.
                <div className="bg-secondary-container/15 text-on-surface-variant mt-3 inline-flex max-w-full items-center gap-2 rounded-lg px-2 py-1 font-mono text-xs">
            ...
            <div className="neu-inset bg-surface-container-low mt-auto flex min-h-11 items-center justify-between rounded-2xl py-1 pr-1.5 pl-4">
              <span className="text-muted truncate pr-3 text-sm">Ask about courses, campus…</span>
          ...
          {/* Map panel — no border-l, uses shadow separation */}
          <div className="neu-inset bg-surface-container-low relative hidden w-1/2 shrink-0 overflow-hidden sm:block">
            <svg
              viewBox="0 0 300 340"
            ...
            >
              ...
              <text x="88" y="276" fontSize="13" fontWeight="500" fill="var(--on-surface-variant)">
                ICCS
              </text>
              <text x="238" y="90" fontSize="13" fontWeight="500" fill="var(--on-surface-variant)">
                Nest
              </text>
            </svg>

            {/* Collapse button */}
            <span className="glass-neu-compact text-on-surface-variant absolute top-3 left-3 flex size-8 items-center justify-center rounded-xl">
              <svg
                viewBox="0 0 24 24"
                width="15"
                height="15"
            ...
            {/* Route info card */}
            <div className="glass-neu-compact absolute top-3 right-3 flex items-center gap-2 rounded-xl px-3 py-2">
